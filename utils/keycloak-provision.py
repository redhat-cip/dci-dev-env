...
#  http http://localhost:8080/auth/realms/dci-test/protocol/openid-connect/auth?client_id=dci-cs\&response_type=id_token\&scope=openid\&nonce=n-0S6_WzA2Mj\&redirect_uri=http://localhost:5000/rh-partner

# $ curl -d "client_id=admin-cli" -d "username=dci" -d "password=dci" -d "grant_type=password"  http://localhost:8080/auth/realms/master/protocol/openid-connect/token

# POST /admin/realms/master/clients
