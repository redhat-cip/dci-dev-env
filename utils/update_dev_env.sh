...
then
    ...
    docker-compose -f dci.yml -f dci-db_init.yml -f dci-swift.yml pull
    docker-compose -f dci.yml -f dci-db_init.yml -f dci-swift.yml build
    docker-compose -f dci.yml -f dci-db_init.yml -f dci-swift.yml down -v
    docker-compose -f dci.yml -f dci-db_init.yml -f dci-swift.yml up -d
