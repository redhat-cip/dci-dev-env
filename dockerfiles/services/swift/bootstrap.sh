...
#swift-ring-builder /etc/swift/object.builder add r1z1-127.0.0.1:6010/sdb 1
#swift-ring-builder /etc/swift/container.builder add r1z1-127.0.0.1:6011/sdb 1
#swift-ring-builder /etc/swift/account.builder add r1z1-127.0.0.1:6012/sdb 1
...
USER_ID=`openstack user create test --project $PROJECT_ID --pass test $AUTH | grep " id " | awk '{print $4}'`
